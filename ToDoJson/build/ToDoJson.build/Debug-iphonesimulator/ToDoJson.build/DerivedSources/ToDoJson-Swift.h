...
#ifndef TODOJSON_SWIFT_H
#define TODOJSON_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ToDoJson",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8ToDoJson11AppDelegate")
...
/// RootView for the <code>MainScreen</code>
SWIFT_CLASS("_TtC8ToDoJson14MainScreenView")
...
SWIFT_CLASS("_TtC8ToDoJson13SceneDelegate")
...
/// RootView for the <code>TaskScreen</code>
SWIFT_CLASS("_TtC8ToDoJson14TaskScreenView")
@interface TaskScreenView : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC8ToDoJson8ToDoCell")
...
SWIFT_CLASS_NAMED("ToDoMO")
@interface ToDoMO : NSManagedObject
...
@interface ToDoMO (SWIFT_EXTENSION(ToDoJson))
@property (nonatomic) int64_t id;
@property (nonatomic) BOOL completed;
@property (nonatomic, copy) NSString * _Nonnull todo;
@property (nonatomic) int64_t userId;
@property (nonatomic, copy) NSString * _Nullable taskDescription;
@property (nonatomic, copy) NSDate * _Nullable deadline;
@end
